...
3. Deploy it as a **Web app**. Run it as **you** and grant access only to the account(s) that will use the extension.
...
The extension now appends each job you explicitly save, including title, company, source, location, posting time, capture time, originating search, and the direct job link.
